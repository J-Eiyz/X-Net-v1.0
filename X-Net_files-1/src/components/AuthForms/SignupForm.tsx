  ...
  return (
    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
      ...
      <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
        ...
        <div>
          <label htmlFor="signup-email" className="block mb-2 text-sm font-medium text-gray-300">
            Email
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
        ...
        <div>
          <label htmlFor="signup-password" className="block mb-2 text-sm font-medium text-gray-300">
            Password
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3 text-sm">
            <label htmlFor="terms" className="font-light text-gray-400">
              I accept the <a className="font-medium text-xblue-500 hover:underline" href="#">Terms and Conditions</a>
            </label>
          </div>
        </div>
        ...
        >
          {isLoading ? (
            ...
            <UserPlus className="mr-2 -ml-1 w-5 h-5" />
          )}
          Create an account
        </button>
